...
export const postVanKhanMung1NgayRam: BlogPost = {
  ...
  authorRole: 'Nghi lễ cổ truyền',
  tags: ['Văn khấn', 'Mùng 1', 'Ngày rằm', 'Cúng gia tiên', 'Phong tục'],
  keywords: ['văn khấn mùng 1', 'văn khấn ngày rằm', 'văn khấn thần linh', 'văn khấn gia tiên', 'lễ cúng ngày sóc ngày vọng'],
  content: `
