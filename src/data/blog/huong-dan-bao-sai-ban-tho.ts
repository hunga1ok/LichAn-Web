...
export const postHuongDanBaoSaiBanTho: BlogPost = {
  ...
  authorRole: 'Nghi lễ thờ cúng',
  tags: ['Bao sái ban thờ', 'Tỉa chân nhang', 'Phong tục cuối năm', 'Tết', 'Tài lộc'],
  keywords: ['bao sái ban thờ', 'tỉa chân nhang cuối năm', 'lau dọn bàn thờ', 'văn khấn bao sái', 'quy trình tỉa chân hương'],
  content: `
